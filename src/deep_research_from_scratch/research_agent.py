...
summarization_model = init_chat_model(model="gemini-3.5-flash", model_provider="google_genai", temperature=0.0)  # Alternatives: "openai:gpt-4.1-mini", "anthropic:claude-haiku-3-5-20241022"
